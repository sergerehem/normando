...
<!-- HEADER: SOCIAL ICONS -->
                    <ul class="socials unstyled">
                        <li><a class="twitter" href="http://twitter.com/normandotrans"></a></li>
                        <li><a class="facebook" href="http://facebook.com/NormandoTransportes"></a></li>
                        <li><a class="youtube" href="http://www.youtube.com/NormandoTransportes"></a></li>
                    </ul>
                </div>
            </div>
